...
/**
 * @function
 * @memberof module:Systems.checkCollision
* @description Projects collider onto a normal vector by returning the interval containing the dot product of the axis with its vertices
 ...
 * @function
 * @memberof module:Systems.checkCollision
 * @description Iterates through all non-colinear axes of both colliders, and returns true if any of their projections are disjointed
