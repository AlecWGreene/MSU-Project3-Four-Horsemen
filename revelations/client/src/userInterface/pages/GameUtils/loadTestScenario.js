...
export default function loadTestScenario(manager){
    ...
    // manager.gameState.playerMoney = 8000;
    // manager.placeBase(manager.gameState.mapGrid.tiles[8][9]);
    // manager.placeTower("Tower_Laser2", manager.gameState.mapGrid.tiles[8][9]);
    // manager.placeBase(manager.gameState.mapGrid.tiles[8][11]);
    // manager.placeTower("Tower_Cannon3", manager.gameState.mapGrid.tiles[8][11]);
    // manager.placeBase(manager.gameState.mapGrid.tiles[6][6]);
    // manager.placeTower("Tower_Cannon1", manager.gameState.mapGrid.tiles[6][6]);
    // manager.gameState.waveIndex = 19;
}